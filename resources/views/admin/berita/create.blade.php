...
@section('title', 'Tulis Berita Baru — Panel Admin')
...
<div class="p-6 sm:p-8 space-y-6">
    <div>
        ...
        <h1 class="text-xl font-black text-slate-900">Tulis Berita Baru</h1>
        <p class="text-xs text-slate-500 mt-1">Publikasikan informasi resmi kepada pelaku usaha dan masyarakat.</p>
    </div>
